...
public class CMAMarioSolver {
	...
	public static final int Z_SIZE = 32*5; // length of latent space vector
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<loops; i++){
            ...
            FileWriter write = new FileWriter("mytimeline/timeline"+i+".txt", true);
        ...
        FileWriter write = new FileWriter("mytimeline/ex_output.txt", true);
